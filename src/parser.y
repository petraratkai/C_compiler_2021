...
declarator:
		pointer direct_declarator 																{$$ = new DirectDecl( (new Variable($2->getId(), IntType))->getId(), new Number(1));}
	|	direct_declarator 																		{$$ = $1;}
;
